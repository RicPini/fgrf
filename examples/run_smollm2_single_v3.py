#!/usr/bin/env python3
"""
Minimal example: Run FGRF v3 on SmolLM2-360M.
Equivalent to:
    python3 fgrf_multi_model_v3.py --model HuggingFaceTB/SmolLM2-360M --layers 20
"""
...
def main():
    print("=" * 60)
    print("FGRF v3 Example: SmolLM2-360M")
    print("=" * 60)
