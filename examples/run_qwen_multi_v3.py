#!/usr/bin/env python3
"""
Minimal example: Run FGRF v3 on Qwen2.5-0.5B with a larger text batch.
Equivalent to:
    python3 fgrf_multi_model_v3.py --model Qwen/Qwen2.5-0.5B \
        --layers 20 --train-texts 10 --eval-texts 20
"""
...
def main():
    print("=" * 60)
    print("FGRF v3 Example: Qwen2.5-0.5B (multi-input batch)")
    print("=" * 60)
    ...
    print(f"\n[2] Training texts: {len(train_texts)}")
